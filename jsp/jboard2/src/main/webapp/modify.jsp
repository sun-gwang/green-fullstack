			...
			del.onclick = (e) =>{
				...
				if(confirm('정말 삭제 하시겠습니까?')){
					...
					.then((data)=>{
						...
						// 해당 삭제링크의 부모태그 p 태그를 동적 제거
						del.parentNode.remove();
						
						// 만약 파일정보가 더이상 없으면 파일 입력필드 동적 생성
						const count = document.getElementsByClassName('fileDel').lenght;
        ...
        <main id="board">
            <section class="modify">
                ...
                <input type="hidden" name="no" value="${articleDTO.no}">
                    ...
                    <div>
                        <a href="/jboard2/list.do?no=${articleDTO.no}" class="btn btnCancel">취소</a>
