...
class User1RepositoryTest {
    ...
    public void findUser1ByAgeLessThan(){
        List<User1> user1s = repository.findUser1ByAgeLessThan(20);
        log.warn(user1s.toString());
    }
    @Test
    ...
    public void findUser1ByAgeBetween(){
        List<User1> user1s = repository.findUser1ByAgeBetween(10, 21);
        log.warn(user1s.toString());
    }
    @Test
    ...
    public void findUser1ByNameLike(){
        List<User1> user1s = repository.findUser1ByNameLike("김땡땡");
        log.warn(user1s.toString());
    }
    @Test
    ...
    @Test
    public void findUser1ByOrderByAgeGreaterThanOrderByAgeDesc(){
    ...
    public void selectUser1ByUid(){
        List<Object[]> user1s = repository.selectUser1ByUid("김땡땡");
        log.warn(user1s.toString());
    }
}