...
public class QueryDSLTests {
    ...
    public void test05(){
        ...
        List<Customer> customers = jpaQueryFactory
                .selectFrom(qCustomer)
                .where(qCustomer.age.in(21,31,41)).fetch();
    ...
    @Test
    public void test09(){
        // select sum(`price`) as `priceSum`, avg(`price`) as.....
    ...
    @Test
    public void test10(){
        // select ~~~ from order where orderStatus=1 group by `orderer` having custId >= 2;
    ...
    public void test13(){
        String keyword = "부산";
        BooleanExpression expression = qCustomer.name.containsIgnoreCase(keyword)
