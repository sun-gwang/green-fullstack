...
public class MultidimensionalArrayByNewExample {
	...
	public static void main(String[] args) {
		...
		int [][] mathScores = new int [2][3]; //{O,O,O},{O,O,O} 1차원 3개, 2차원 2개->3개짜리가 두개
		...
		int [][] englishScores = new int[2][]; // int[2차][1차];
		...
		// englishScores[0].length -> 2
		// englishScores[1].length -> 3
		for(int i=0; i<englishScores.length; i++) {
		...
		System.out.println("전체 학생 영어평균 : "+totalEnglishAvg);
